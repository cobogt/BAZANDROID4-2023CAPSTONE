...
import com.jgt.content.movies.presentation.actions.RefreshRepositoryActions
import com.jgt.core.storage.Resource
        ...
        onRefresh = {
            viewModel.dispatch(
                RefreshRepositoryActions.RefreshMovieList.apply {
                    gate = com.jgt.core.mvi.gatesCatalog.CheckInternetGate
                }
            )
            runCoroutineInt += 1
        },
