...
import com.jgt.wizelinebaz2023.core.gates.ExitGateAction
import com.jgt.wizelinebaz2023.core.gates.GateResult
...
fun CheckConnectionComponent() {
    ...
    Scaffold { padding ->
        Column(Modifier.padding( padding ).fillMaxWidth().fillMaxHeight(),
            ...
            Button(onClick = {
                viewModel.dispatch( ExitGateAction( GateResult.Error()) )
